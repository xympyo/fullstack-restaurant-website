...
<head>
    ...
    <title>Dashboard | Menu | Store</title>
</head>
                ...
                <div class="container outline p-3">
                    <form method="post" action="{{ route('dashboard.menu.store') }}">
                        ...
                        <div class="mt-3 mb-3">
                            ...
                            <input type="text" name="foodName" class="form-control" id="foodName" placeholder="Your Food Name Here">
                        </div>
                        <div class="mb-3">
                            <label for="foodDesc" class="form-label">Food Description</label>
                            <input type="text" name="foodDesc" class="form-control" id="foodDesc" placeholder="Your Food Description Here">
                        </div>
                        <div class="mb-3">
                            <label for="foodPrice" class="form-label">Food Price</label>
                            <input type="number" name="foodPrice" class="form-control" id="foodPrice" placeholder="Your Food Price Here">
                        </div>
                        <div class="mb-3">
                            <label for="foodCategory" class="form-label">Choose the Category</label>
                            <select class="form-select" name="foodCategory" id="foodCategory">
                                <option selected>Choose The Drink Category</option>
