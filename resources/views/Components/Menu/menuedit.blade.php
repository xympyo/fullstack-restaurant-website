                ...
                <div class="container outline p-3">
                    <form method="post">
                        <div class="mt-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="foodName" placeholder="{{ $f_names }}">
                        </div>
                        <div class="mb-3">
                            <label for="foodDesc" class="form-label">Food Description</label>
                            <input type="text" class="form-control" id="foodDesc" placeholder="{{ $f_desc }}">
                        </div>
                        <div class="mb-3">
                            <label for="foodPrice" class="form-label">Food Price</label>
                            <input type="number" class="form-control" id="foodPrice" placeholder="{{ $f_price }}">
                        </div>
