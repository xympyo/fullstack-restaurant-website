...
<head>
    ...
    <title>Cepi Cafe | Customer</title>
    <style>
    </style>
</head>
    ...
    <div class="row mt-5">
        ...
        <div class="col-8">
            ...
            <div class="row mt-4 mb-5">
                <div class="col-3"></div>
                <div class="col-6">
                    <form action="{{ route('restaurant.cust.post') }}" method="POST">
                        @csrf
                        @method('post')
                        <div class="d-flex flex-column mt-3">
                            <label class="fw-medium" for="name">Name</label>
                            <input class="under-border" type="text" name="cust_name"
                                placeholder="Please input your name here">
                        </div>
                        <div class="d-flex flex-column mt-3">
                            <label class="fw-medium" for="phone_number">Phone Number</label>
                            <input class="under-border" type="text" name="cust_phone_number"
